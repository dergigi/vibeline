...
echo "  make setup-pre-commit  - Set up pre-commit hooks (optional)"
echo ""
echo "💡 Pre-commit hooks are available but not installed by default."
echo "   Run 'make setup-pre-commit' if you want automatic checks on commits."
echo "📖 See .github/BRANCH_PROTECTION.md for setting up GitHub branch protection."
